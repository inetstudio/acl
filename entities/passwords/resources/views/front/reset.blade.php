...
<form>
    ...
    <div class="form-row form-submit">
        <input type="submit" class="skin-btn skin-btn-reg ajax-submit" data-href="{{ route('front.acl.passwords.reset.post') }}" data-done="pwd" data-success="login" data-backdrop="hide" value="Сохранить">
    </div>
</form>
