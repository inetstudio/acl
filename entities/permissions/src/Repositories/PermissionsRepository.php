...
namespace InetStudio\ACL\Permissions\Repositories;
 ...
 */
class PermissionsRepository implements PermissionsRepositoryContract
{
    /**
     ...
     * @return PermissionModelContract
     */
    public function getItemByID(int $id): PermissionModelContract
    {
