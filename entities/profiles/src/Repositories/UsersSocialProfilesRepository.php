...
namespace InetStudio\ACL\Profiles\Repositories;
...
/**
 * Class UsersSocialProfilesRepository.
 */
class UsersSocialProfilesRepository implements UsersSocialProfilesRepositoryContract
{
    /**
     * @var UserSocialProfileModelContract
     */
    private $model;
     ...
     *
     * @param UserSocialProfileModelContract $model
     */
    public function __construct(UserSocialProfileModelContract $model)
    {
        $this->model = $model;
    }
     ...
     *
     * @return UserSocialProfileModelContract
     */
     ...
     * @return UserSocialProfileModelContract
     */
    public function getItemByID(int $id): UserSocialProfileModelContract
    {
     ...
     * @return UserSocialProfileModelContract
     */
    public function save(array $data, int $id): UserSocialProfileModelContract
    {
