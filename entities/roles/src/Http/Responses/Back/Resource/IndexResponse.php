...
use InetStudio\ACL\Roles\Contracts\Services\Back\DataTables\IndexServiceContract as DataTableServiceContract;
...
class IndexResponse implements IndexResponseContract
{
    ...
    public function toResponse($request)
    {
        ...
        return view('admin.module.acl.roles::back.pages.index', compact('table'));
    }
}
